...
async function main() {
    ...
    const aPost1 = await users.makePost(andrew1['_id'], 'acapro', 'Dumbbells and Backpack', "../public/photos/img.png", '3 Cool Ln.', 'Dumbbells; and; Backpack', 'true') //make creates the post, and adds it to user as well, returns postId
    await users.makePost(andrew1['_id'], 'acapro', 'Potted Plant', '../public/photos/img2.jpg', '400 West St.', 'Potted; Plant', 'false')
    ...
    const nPost = await users.makePost(nick1['_id'], 'nmule', 'Couch', '../public/photos/img3.jpg', '800 Washington St.', 'Couch', 'true') //returns postId
    const nPostID = nPost
    ...
    const cPost1 = await users.makePost(casey1['_id'], 'cmulrooney', 'Mulch', '../public/photos/img4.jpg', '300 Bloomfield Ave.', 'Mulch', 'false')
    await users.makePost(casey1['_id'], 'cmulrooney', 'White Chairs', '../public/photos/img5.jpg', 'Outside Babbio Center', 'White; Chairs', 'false')
    ...
    const chPost = await users.makePost(chance1['_id'], 'cassiamah', 'Kids Bike', '../public/photos/img6.jpg', '800 Washington St.', 'Kids; Bike', 'true')
